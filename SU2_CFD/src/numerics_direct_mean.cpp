...
//            su2double alpha, plate_angle, Nx, Ny, Tx, Ty;
//            alpha = -10; //Angle of flat plate in degrees
...
//            su2double Velocity_i_x, Velocity_i_y, WdotN, delta, vel_mag, sq_vel, BF_magnitude_inc, sound, M_rel, K, Kprime, BF_magnitude, BF_n, BF_t, BF_nx, BF_ny, BF_tx, BF_ty, BF_x, BF_y;
...
//            sound = sqrt(gamma * R_gas * V_i[0]); // V_i is the primitive variables at point i, T is first value
//            M_rel = vel_mag / sound;
//            if (M_rel < 1) {
...
//                }
//            }
//            BF_magnitude = BF_magnitude_inc * K;
...
//            x_coord = Coord_i[0];
//            theta = (-35 + x_coord * 20) * pi / 180; //linear variation of plate angle from LE to TE TODO(generalize): Make useful for coordinates not from 0 to 1
//            Nx = sin(theta);
//            Ny = cos(theta);
//            Tx = cos(theta);
//            Ty = sin(pi + theta);
